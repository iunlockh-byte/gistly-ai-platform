...
with open("Important_Codes_Short_Printable.html", "w", encoding="utf-8") as f:
    f.write(html_content)

print("Generated Important_Codes_Short_Printable.html")
